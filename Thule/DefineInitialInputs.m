...
CtrlVar.dt=1e-5;   CtrlVar.DefineOutputsDt=1;  CtrlVar.ATSdtMin=1e-4  ; 
...
CtrlVar.ThickMin=1;
CtrlVar.InfoLevelThickMin=1; % This provides information on whether the ice thickness drops below min ice thickness.
                             % 

CtrlVar.ResetThicknessToMinThickness=0;    % reset thickness to min icethickness
CtrlVar.ThicknessConstraints=1;            % use thickness constraints
